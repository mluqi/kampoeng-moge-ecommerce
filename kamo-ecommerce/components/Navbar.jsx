...
const Navbar = () => {
  ...
  const handleShare = () => {
    // Ambil data dari meta tag untuk preview yang lebih kaya
    ...
    const text = ogDescription
      ...
      : `Kunjungi halaman ini: ${document.title}`;
  ...
  return (
    <>
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between px-8 md:px-8 lg:px-32 py-4 bg-white text-gray-700 shadow-sm relative">
        ...
        <div className="hidden md:flex items-center gap-2 lg:gap-0 md:gap-0 relative">
          ...
          <button
            onClick={handleShare}
            className="z-20 cursor-pointer text-gray-500 hover:text-accent p-1"
              ...
              <div className="hidden lg:flex md:flex items-center gap-1">
                {user && (
                  <Link
                    ...
                    className="relative text-gray-500 hover:text-accent p-1"
                  >
